    ...
    <div>
      <section className="relative bg-cover bg-[url('/main-bg.png')] w-full h-[100vh]">
        ...
        <div className="container mx-auto relative z-10">
          <p className="max-w-[1477px] text-[25px] md:text-[48px] lg:text-[56px] xl:text-[84px] font-bold text-center md:text-start text-textWhite pt-[237px] font-playfair">
            Ijtimoiy tarmoqlarda bizni kuzatib boring
          </p>
        </div>
        <div className="container mx-auto absolute pt-[100px] flex gap-12 left-1/3">
          <Link
          ...
          >
            <Image
              ...
              className="w-[28px] lg:w-[60px]"
            />
            <p className="text-textWhite text-[14px] lg:text-[24px]text-[24px]">
              Telegram
            </p>
          </Link>
          <Link
          ...
          >
            <Image
              ...
              className="w-[28px] lg:w-[60px]"
            />
            <p className="text-textWhite text-[14px] lg:text-[24px]">YouTube</p>
          </Link>
        </div>
      </section>
      <section>
